...
def d2TSI_dV2dP2(Surrogate, Pg, Qg, Pl, Ql, muTSI, st_args):
    if Surrogate['model_type'] == "CNN":
        ...
        return d2TSI_dV2dP2_UQ_CNN_STD(Surrogate, Pg, Qg, Pl, Ql, muTSI, st_args)
...
# f = μ − β std
def d2TSI_dV2dP2_UQ_CNN_STD(UQ_CNNmodel, Pg, Qg, Pl, Ql, muTSI, st_args):
    Mul_confi = st_args['Mul_confi']
    model = UQ_CNNmodel["model"]
    dtype = UQ_CNNmodel['dtype'] 
